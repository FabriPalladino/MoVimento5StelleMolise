							...
							<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'twentysixteen' ); ?>">
								<?php
									wp_nav_menu( array(
										...
										'menu_class'     => 'primary-menu  site-inner',
									 ) );
								?>
								<!-- <li class="menu-item">
									<i class="fa fa-search-plus js-search-trigger" aria-hidden="true"></i>
								</li> -->
							</nav><!-- .main-navigation -->
						<?php endif; ?>
...
<figure class="internal-header" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/images/banner-internal.jpg')">
		...
		<header class="page-header site-inner">
			<h1 class="page-search-title page-title">Risultati della ricerca</h1>
		</header><!-- .entry-header -->
</figure>
